...
StartTest(function (t) {
    ...
    t.diag("Test - Selecting all filters for the DFMEA Recommendations Section Name");
    var grid;
    ...
    t.chain(
        ...
        function (next) {
            t.chainClick(Ext.getCmp('DFMEA_Recommendations-Action_Status-Completed'),
                         Ext.getCmp('DFMEA_Recommendations-Action_Status-In_Progress'),
                         Ext.getCmp('DFMEA_Recommendations-Action_Status-Planned'),
                         Ext.getCmp('DFMEA_Recommendations-Action_Status-No_Action_Planned'),
                         Ext.getCmp('DFMEA_Recommendations-Action_Type-No_Action_Required'),
                         Ext.getCmp('DFMEA_Recommendations-Action_Type-Mfg._Controls'),
                         Ext.getCmp('DFMEA_Recommendations-Action_Type-Prognostic_Health_Management'),
                         Ext.getCmp('DFMEA_Recommendations-Action_Type-Operational_and_Maintenance_Procedures'),
                         Ext.getCmp('DFMEA_Recommendations-Action_Type-Engineering_Actions'),
                         Ext.getCmp('DFMEA_Recommendations-Action_Type-Test'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Field_Introduction'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Requirement_&_Concept_Review'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Plan_of_Record_Review'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Project_Launch'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Business_Commercialization'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Obsolescence_Strategy'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Project_Request'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Requirement_&_Concept_Validation'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Realization_Launch'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-EPS_Production_Launch'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Project_Closure'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-End_of_Production'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Concurrent_Team_Launch'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Realization_Strategy_Review'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-ENP_Production_Launch'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Product_Readiness_Review'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-Portfolio_Performance'),
                         Ext.getCmp('DFMEA_Recommendations-Due_By_CDP-End_of_Support'), next)
        },
         function (next) {
             //Write a test that checks date format 
             t.type(Ext.getCmp('DFMEA_Recommendations-Max_RPN-txtNumber1'), '25', next);
         },
         function (next) {
             //Write a test that checks date format 
             t.type(Ext.getCmp('DFMEA_Recommendations-Target_Completion_Date-txtDate1'), '12/12/2012', next);
         },
