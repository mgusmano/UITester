...
StartTest(function (t) {
    ...
    t.chain(
        ...
        function (next) {
            ...
            var pos = secNameArray.indexOf('Product Test Tracker');
        ...
        function (next) {
            t.chainClick(Ext.getCmp('Product_Test_Tracker-DUT_Level-System'),
                         Ext.getCmp('Product_Test_Tracker-DUT_Level-Assembly'),
                         Ext.getCmp('Product_Test_Tracker-DUT_Level-Sub-Assy'),
                         Ext.getCmp('Product_Test_Tracker-DUT_Level-Component'),
                         Ext.getCmp('Product_Test_Tracker-Test_Class-Experiment'),
                         Ext.getCmp('Product_Test_Tracker-Test_Class-Verification'),
                         Ext.getCmp('Product_Test_Tracker-Test_Class-Validation'),
                         Ext.getCmp('Product_Test_Tracker-Test_Pass___Fail-Pass'),
                         Ext.getCmp('Product_Test_Tracker-Test_Status-Planned'),
                         Ext.getCmp('Product_Test_Tracker-Test_Status-In_Progress'),
                         Ext.getCmp('Product_Test_Tracker-Test_Status-Completed'),
                         Ext.getCmp('Product_Test_Tracker-Test_Status-No_Action_Planned'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Field_Introduction'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Requirement_&_Concept_Review'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Plan_of_Record_Review'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Project_Launch'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Business_Commercialization'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Obsolescence_Strategy'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Project_Request'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Requirement_&_Concept_Validation'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Realization_Launch'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-EPS_Production_Launch'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Project_Closure'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-End_of_Production'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Concurrent_Team_Launch'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Realization_Strategy_Review'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-ENP_Production_Launch'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Product_Readiness_Review'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-Portfolio_Performance'),
                         Ext.getCmp('Product_Test_Tracker-Test_Due_By_CDP-End_of_Support'), next)
        },
        function (next) {
