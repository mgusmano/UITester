StartTest(function (t) {
    ...
    t.diag("Test - Sections Configured in ASCENDING order");
    var grid;
    var inJSON;
    var outJSON;
    t.chain(
        ...
        function (next) {
            ...
            t.isDeeply(true, true, '1. Checking to see if Section Names are in ASCENDING order...');
            t.isDeeply(true, true, 'Section Names are in ASCENDING ORDER');
