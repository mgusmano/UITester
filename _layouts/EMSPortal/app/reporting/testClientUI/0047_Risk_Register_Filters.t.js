    ...
    t.chain(
        ...
        function (next) {
         ...
         function (next) {
             ...
             t.chainClick(Ext.getCmp('Risk_Register-Risk_Occurrence-1'),
                          Ext.getCmp('Risk_Register-Risk_Occurrence-2'),
                          Ext.getCmp('Risk_Register-Risk_Occurrence-3'),
                          Ext.getCmp('Risk_Register-Risk_Occurrence-4'),
                          Ext.getCmp('Risk_Register-Risk_Occurrence-5'),
                          Ext.getCmp('Risk_Register-Risk_Severity-1'),
                          Ext.getCmp('Risk_Register-Risk_Severity-2'),
                          Ext.getCmp('Risk_Register-Risk_Severity-3'),
                          Ext.getCmp('Risk_Register-Risk_Severity-4'),
                          Ext.getCmp('Risk_Register-Risk_Severity-5'),
						  Ext.getCmp('Risk_Register-Exposure_Category-Performance'),
						  Ext.getCmp('Risk_Register-Exposure_Category-Schedule'),
						  Ext.getCmp('Risk_Register-Exposure_Category-Cost'),
						  next);
         },
		function (next) {
		    t.type(Ext.getCmp('Risk_Register-Max_Risk_Score-txtNumber1'), '1', next);
		},
