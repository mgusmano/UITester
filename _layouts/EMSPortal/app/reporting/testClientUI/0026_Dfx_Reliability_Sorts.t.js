...
StartTest(function (t) {
    ...
    t.chain(
     ...
     function (next) {
         t.chainClick(Ext.getCmp('DfX_Reliability-Deliverable_Group-Comment-cbxSortGroupFieldEnabled'),
     Ext.getCmp('DfX_Reliability-Deliverable_Group-Date_Recorded-cbxSortGroupFieldEnabled'),
     Ext.getCmp('DfX_Reliability-Deliverable_Group-Status-cbxSortGroupFieldEnabled'),
     Ext.getCmp('DfX_Reliability-Deliverable_Group-Plan_Score-cbxSortGroupFieldEnabled'),
     Ext.getCmp('DfX_Reliability-Deliverable_Group-Deliverables_Number-cbxSortGroupFieldEnabled'),
     Ext.getCmp('DfX_Reliability-Deliverable_Group-Deliverables_Name-cbxSortGroupFieldEnabled'),
     Ext.getCmp('DfX_Reliability-CDP_Group-Score-cbxSortGroupFieldEnabled'),
     Ext.getCmp('DfX_Reliability-CDP_Group-CDP_Type_Number-cbxSortGroupFieldEnabled'),
     Ext.getCmp('DfX_Reliability-CDP_Group-CDP_Type_Name-cbxSortGroupFieldEnabled'), next)
     },
     function (next) {
         t.diag('Testing sorts for CDP Group'); //CDP GROUP
         var arrowUp_score = Ext.getCmp('DfX_Reliability-CDP_Group-Score-btnSortGroupFieldUp');
         var arrowDown_score = Ext.getCmp('DfX_Reliability-CDP_Group-Score-btnSortGroupFieldDown');
         var arrowUp_cdp = Ext.getCmp('DfX_Reliability-CDP_Group-CDP_Type_Name-btnSortGroupFieldUp');
         var arrowDown_cdp = Ext.getCmp('DfX_Reliability-CDP_Group-CDP_Type_Name-btnSortGroupFieldDown');
         ...
         var arrowUp_comment = Ext.getCmp('DfX_Reliability-Deliverable_Group-Comment-btnSortGroupFieldUp');
         var arrowDown_comment = Ext.getCmp('DfX_Reliability-Deliverable_Group-Comment-btnSortGroupFieldDown');
         var arrowUp_deliverables = Ext.getCmp('DfX_Reliability-Deliverable_Group-Deliverables_Name-btnSortGroupFieldUp');
         var arrowDown_deliverables = Ext.getCmp('DfX_Reliability-Deliverable_Group-Deliverables_Name-btnSortGroupFieldDown');
