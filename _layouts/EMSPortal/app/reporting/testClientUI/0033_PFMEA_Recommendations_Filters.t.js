...
StartTest(function (t) {
    ...
    t.chain(
        ...
        function (next) {
            ...
            var pos = secNameArray.indexOf('PFMEA Recommendations');
        ...
        function (next) {
            t.chainClick(Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Field_Introduction'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Requirement_&_Concept_Review'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Plan_of_Record_Review'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Project_Launch'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Business_Commercialization'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Obsolescence_Strategy'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Project_Request'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Requirement_&_Concept_Validation'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Realization_Launch'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-EPS_Production_Launch'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Project_Closure'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-End_of_Production'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Concurrent_Team_Launch'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Realization_Strategy_Review'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-ENP_Production_Launch'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Product_Readiness_Review'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-Portfolio_Performance'),
                         Ext.getCmp('PFMEA_Recommendations-Due_By_CDP-End_of_Support'),
                         Ext.getCmp('PFMEA_Recommendations-Action_Status-Completed'),
                         Ext.getCmp('PFMEA_Recommendations-Action_Status-In_Progress'),
                         Ext.getCmp('PFMEA_Recommendations-Action_Status-Planned'),
                         Ext.getCmp('PFMEA_Recommendations-Action_Status-No_Action_Planned'),
                         Ext.getCmp('PFMEA_Recommendations-Action_Type-No_Action_Required'),
                         Ext.getCmp('PFMEA_Recommendations-Action_Type-Mfg._Controls'),
                         Ext.getCmp('PFMEA_Recommendations-Action_Type-Prognostic_Health_Management'),
                         Ext.getCmp('PFMEA_Recommendations-Action_Type-Operational_and_Maintenance_Procedures'),
                         Ext.getCmp('PFMEA_Recommendations-Action_Type-Engineering_Actions'),
                         Ext.getCmp('PFMEA_Recommendations-Action_Type-Test'), next)
        },

         function (next) {

             t.type(Ext.getCmp('PFMEA_Recommendations-Max_RPN-txtNumber1'), '100', next);
         },
