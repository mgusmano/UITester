...
function getServerResults() {
    ...
    StartTest(function (t) {
        ...
        function (next) {
            ...
            t.chainClick(Ext.getCmp('Corrective_Actions-Detail_Group-Due_By_CDP_Number-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Corrective_Actions-Detail_Group-Due_By_CDP_Name-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Corrective_Actions-Detail_Group-Action_Group-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Corrective_Actions-Detail_Group-Max_Risk_Score-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Corrective_Actions-Detail_Group-Action_Status_Number-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Corrective_Actions-Detail_Group-Action_Status_Name-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Corrective_Actions-Detail_Group-Action_Type-Number-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Corrective_Actions-Detail_Group-Action_Type-Name-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Corrective_Actions-Detail_Group-Action_Number-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Corrective_Actions-Detail_Group-Action_Name-cbxSortGroupFieldEnabled'), next)
        },
        function (next) {
            t.diag('CHECKING UP AND DOWN BUTTON FUNCTIONALITIES - 1st Item');
            var arrowUp_due_by_cdp = Ext.getCmp('Corrective_Actions-Detail_Group-Due_By_CDP_Number-btnSortGroupFieldUp');
            var arrowDown_due_by_cdp = Ext.getCmp('Corrective_Actions-Detail_Group-Due_By_CDP_Number-btnSortGroupFieldDown');
            if (arrowDown_due_by_cdp.disabled == false && arrowUp_due_by_cdp.disabled == true) {
            ...
            var arrowUp_action_sequence = Ext.getCmp('Corrective_Actions-Detail_Group-Action_Name-btnSortGroupFieldUp');
            var arrowDown_action_sequence = Ext.getCmp('Corrective_Actions-Detail_Group-Action_Name-btnSortGroupFieldDown');
            if (arrowUp_action_sequence.disabled == false && arrowDown_action_sequence.disabled == true) {
            ...
            t.click(Ext.getCmp('Corrective_Actions-Detail_Group-Due_By_CDP_Number-btnSortGroupFieldDown'), next);
        },

            function (next) {

                t.diag('CHECKING UP AND DOWN BUTTON FUNCTIONALITIES - Clicking "Due By CDP" down arrow... ');

                var arrowUp_due_by_cdp_name = Ext.getCmp('Corrective_Actions-Detail_Group-Due_By_CDP_Name-btnSortGroupFieldUp');
                var arrowDown_due_by_cdp_name = Ext.getCmp('Corrective_Actions-Detail_Group-Due_By_CDP_Name-btnSortGroupFieldDown');

                if (arrowDown_due_by_cdp_name.disabled == false && arrowUp_due_by_cdp_name.disabled == true) {
                    t.isDeeply(true, true, 'SUCCESS - First item still has proper arrows enabled and disabled after click');
                }
                else {
                    t.fail('FAIL - First item does not have proper arrows enabled and disabled after click');
                }

                t.click(Ext.getCmp('Corrective_Actions-Detail_Group-Action_Name-btnSortGroupFieldUp'), next);
            },
                function (next) {
                    t.diag('CHECKING UP AND DOWN BUTTON FUNCTIONALITIES - Clicking "Action Sequence" up arrow...');
                    var arrowUp_action_number = Ext.getCmp('Corrective_Actions-Detail_Group-Action_Number-btnSortGroupFieldUp');
                    var arrowDown_action_number = Ext.getCmp('Corrective_Actions-Detail_Group-Action_Number-btnSortGroupFieldDown');

                    if (arrowDown_action_number.disabled == true && arrowUp_action_number.disabled == false) {
                        t.isDeeply(true, true, 'SUCCESS - Action Type has proper arrows enabled and disabled');
                    }
                    else {
                        t.fail('FAIL - Action Type does not have proper arrows enabled and disabled');
                    }
