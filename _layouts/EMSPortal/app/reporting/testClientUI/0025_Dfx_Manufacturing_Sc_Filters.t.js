...
StartTest(function (t) {
    ...
    t.chain(
        ...
        function (next) {
            t.chainClick(Ext.getCmp('DfX_Manufacturing-Sc-CDP_Phase-Concurrent_Team_Launch'),
                        Ext.getCmp('DfX_Manufacturing-Sc-CDP_Phase-ENP_Production_Launch'),
                        Ext.getCmp('DfX_Manufacturing-Sc-CDP_Phase-Project_Closure'),
                        Ext.getCmp('DfX_Manufacturing-Sc-CDP_Phase-Requirement_&_Concept_Review___Validation'),
                        Ext.getCmp('DfX_Manufacturing-Sc-CDP_Phase-EPS_Production_Launch'),
                        Ext.getCmp('DfX_Manufacturing-Sc-CDP_Phase-Obsolescence_Strategy'),
                        Ext.getCmp('DfX_Manufacturing-Sc-CDP_Phase-Realization_Strategy_Review___Realization_Launch'),
                        Ext.getCmp('DfX_Manufacturing-Sc-CDP_Phase-Product_Readiness_Review___Commercialization'),
						Ext.getCmp('DfX_Manufacturing-Sc-CDP_Phase-Field_Introduction'),
                         Ext.getCmp('DfX_Manufacturing-Sc-Deliverable_Status-Planned'),
                         Ext.getCmp('DfX_Manufacturing-Sc-Deliverable_Status-In_Progress'),
                         Ext.getCmp('DfX_Manufacturing-Sc-Deliverable_Status-Completed'),
                         Ext.getCmp('DfX_Manufacturing-Sc-Deliverable_Status-No_Action_Planned'),
                         Ext.getCmp('DfX_Manufacturing-Sc-DfX_Light_Manual_Process_Manufacturing-True'),
                         Ext.getCmp('DfX_Manufacturing-Sc-DfX_Light_Manual_Process_Manufacturing-False'), next);
        },

         function (next) {

             t.type(Ext.getCmp('DfX_Manufacturing-Sc-Deliverable_Plan_Score-txtNumber1'), '10', next);
         },

         function (next) {

             t.type(Ext.getCmp('DfX_Manufacturing-Sc-Score-txtNumber1'), '10', next);
         },
        function (next) {
