...
StartTest(function (t) {
    ...
    t.chain(
        ...
        function (next) {
         ...
         function (next) {
             t.chainClick(Ext.getCmp('Requirements-Prioritization-Key_Differentiators'),
                         Ext.getCmp('Requirements-Prioritization-Must_Have'),
						 Ext.getCmp('Requirements-Prioritization-Performance'),
						 Ext.getCmp('Requirements-Prioritization-Extra_differentiators_or_nice_to_have'),
                         Ext.getCmp('Requirements-Prioritization-Indifferent'),
                         Ext.getCmp('Requirements-Requirement_Type-Total_Cost_Of_Ownership'),
                         Ext.getCmp('Requirements-Requirement_Type-Maintainability'),
                         Ext.getCmp('Requirements-Requirement_Type-Development_Time'),
                         Ext.getCmp('Requirements-Requirement_Type-HSE'),
                         Ext.getCmp('Requirements-Requirement_Type-Functional'),
                         Ext.getCmp('Requirements-Requirement_Type-Usability'),
                         Ext.getCmp('Requirements-Requirement_Type-Development_Cost'),
                         Ext.getCmp('Requirements-Requirement_Type-Other'),
                         Ext.getCmp('Requirements-Requirement_Type-Manufacturability'),
                         Ext.getCmp('Requirements-Requirement_Type-Reliability'),
                         Ext.getCmp('Requirements-Requirement_Type-System_Combinability___Compatability_with_Higher_Level,_Other_Systems'),
                         Ext.getCmp('Requirements-Maturity-0'),
                         Ext.getCmp('Requirements-Maturity-1'),
                         Ext.getCmp('Requirements-Maturity-2'),
                         Ext.getCmp('Requirements-Maturity-3'),
                         Ext.getCmp('Requirements-Maturity-4'), next);
            },
        function (next) {
            t.type(Ext.getCmp('Requirements-Requirement_Type_Level-txtNumber'), '2', next);
        },
        function (next) {
