...
StartTest(function (t) {
    ...
    t.chain(
        ...
        function (next) {
            ...
            var pos = secNameArray.indexOf('Product Maturity Tracker Summary');
        ...
        function (next) {
            ...
            t.chainClick(Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Is_Validated-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Tests_Passed-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Requirement_Max_Risk_Score_-_Cost_-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Requirement_Max_Risk_Score_-_Schedule_-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Requirement_Max_Risk_Score_-_Performance_-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Requirement_Max_Risk_Score-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Requirement_Number-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Requirement_Name-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Requirement_ID-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Requirement_Type_Number-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Requirement_Type_Name-cbxSortGroupFieldEnabled'),
                         Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Requirement_Prioritization_Type-cbxSortGroupFieldEnabled'), next)
        },
        function (next) {
            var arrowUp_isValidated = Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Is_Validated-btnSortGroupFieldUp');
            var arrowDown_isValidated = Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Is_Validated-btnSortGroupFieldDown');
            var arrowUp_prioritization = Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Prioritization_Type-btnSortGroupFieldUp');
            var arrowDown_prioritization = Ext.getCmp('Product_Maturity_Tracker_Summary-Requirement_Group-Prioritization_Type-btnSortGroupFieldDown');

            t.diag('CHECKING UP AND DOWN BUTTON FUNCTIONALITIES - 1st Item');
            if (arrowDown_isValidated.disabled == false && arrowUp_isValidated.disabled == true) {
