...
StartTest(function (t) {
    ...
    t.chain(
        ...
        function (next) {
            ...
            var pos = secNameArray.indexOf('Corrective Actions');
        ...
        function (next) {
            t.chainClick(Ext.getCmp('Corrective_Actions-Action_Status-Completed'),
                         Ext.getCmp('Corrective_Actions-Action_Status-Planned'),
                         Ext.getCmp('Corrective_Actions-Action_Status-In_Progress'),
                         Ext.getCmp('Corrective_Actions-Action_Status-No_Action_Planned'),
                         Ext.getCmp('Corrective_Actions-Action_Type-No_Action_Required'),
                         Ext.getCmp('Corrective_Actions-Action_Type-Mfg._Controls'),
                         Ext.getCmp('Corrective_Actions-Action_Type-Prognostic_Health_Management'),
                         Ext.getCmp('Corrective_Actions-Action_Type-Operational_and_Maintenance_Procedures'),
                         Ext.getCmp('Corrective_Actions-Action_Type-Engineering_Actions'),
                         Ext.getCmp('Corrective_Actions-Action_Type-Test'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Field_Introduction'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Requirement_&_Concept_Review'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Plan_of_Record_Review'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Project_Launch'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Business_Commercialization'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Obsolescence_Strategy'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Project_Request'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Requirement_&_Concept_Validation'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Realization_Launch'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-EPS_Production_Launch'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Project_Closure'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-End_of_Production'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Concurrent_Team_Launch'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Realization_Strategy_Review'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-ENP_Production_Launch'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Product_Readiness_Review'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-Portfolio_Performance'),
                         Ext.getCmp('Corrective_Actions-Due_By_CDP-End_of_Support'), next)
        },
         function (next) {
             //Write a test that checks date format 
             t.type(Ext.getCmp('Corrective_Actions-Max_Risk-txtNumber1'), '25', next);
         },
         function (next) {
             t.type(Ext.getCmp('Corrective_Actions-Target_Completion_Date-txtDate1'), '12/12/2013', next);
         },
         function (next) {
             t.chainClick(Ext.getCmp('Corrective_Actions-Tracked_in_Project_Plan-True'),
                         Ext.getCmp('Corrective_Actions-Tracked_in_Project_Plan-False'),
                         Ext.getCmp('Corrective_Actions-Tracked_in_Project_Plan-Blank'), next)
         },
